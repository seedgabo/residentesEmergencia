! function (t, e) {
  ...
  return function (t) {
    ...
    function n(t, e) {
      ...
      return d ? (p("ignoring socket cache for %s", a), r = c(a, e)) : (u[h] || (p("new io instance for %s", a), u[h] = c(a, e)), r = u[h]), n.query && !e.query ? e.query = n.query : e && "object" === i(e.query) && (e.query = o(e.query)), r.socket(n.path, e)
    }
    ...
    t.exports = e = n;
    var u = e.managers = {};
    e.protocol = a.protocol, e.connect = n, e.Manager = r(13), e.Socket = r(39)
  }, function (t, e, r) {
    (function (e) {
      "use strict";
    ...
    (function (n) {
      ...
      e = t.exports = r(5), e.log = s, e.formatArgs = i, e.save = a, e.load = c, e.useColors = o, e.storage = "undefined" != typeof chrome && "undefined" != typeof chrome.storage ? chrome.storage.local : p(), e.colors = ["lightseagreen", "forestgreen", "goldenrod", "dodgerblue", "darkorchid", "crimson"], e.formatters.j = function (t) {
        try {
      ...
      function r() {
        if (r.enabled) {
          var t = r,
            n = +new Date,
            o = n - (p || n);
          t.diff = o, t.prev = p, t.curr = n, p = n;
    ...
    function i(t) {
      ...
      for (var r = ("string" == typeof t ? t : "").split(/[\s,]+/), n = r.length, o = 0; o < n; o++) r[o] && (t = r[o].replace(/\*/g, ".*?"), "-" === t[0] ? e.skips.push(new RegExp("^" + t.substr(1) + "$")) : e.names.push(new RegExp("^" + t + "$")))
    }
    ...
    e = t.exports = o.debug = o["default"] = o, e.coerce = c, e.disable = s, e.enable = i, e.enabled = a, e.humanize = r(6), e.names = [], e.skips = [], e.formatters = {};
    var p
  }, function (t, e) {
    function r(t) {
    ...
    function o(t) {
      var r = "" + t.type;
      return e.BINARY_EVENT !== t.type && e.BINARY_ACK !== t.type || (r += t.attachments + "-"), t.nsp && "/" !== t.nsp && (r += t.nsp + ","), null != t.id && (r += t.id), null != t.data && (r += JSON.stringify(t.data)), h("encoded %j as %s", t, r), r
    }
    ...
    function a(t) {
      ...
      if (null == e.types[n.type]) return u();
      ...
      return t.charAt(++r) && (n = c(n, t.substr(r))), h("decoded %s as %j", t, n), n
    }
    ...
    e.protocol = 4, e.types = ["CONNECT", "DISCONNECT", "EVENT", "ACK", "ERROR", "BINARY_EVENT", "BINARY_ACK"], e.CONNECT = 0, e.DISCONNECT = 1, e.EVENT = 2, e.ACK = 3, e.ERROR = 4, e.BINARY_EVENT = 5, e.BINARY_ACK = 6, e.Encoder = n, e.Decoder = s, n.prototype.encode = function (t, r) {
      if (t.type !== e.EVENT && t.type !== e.ACK || !l(t.data) || (t.type = t.type === e.EVENT ? e.BINARY_EVENT : e.BINARY_ACK), h("encoding packet %j", t), e.BINARY_EVENT === t.type || e.BINARY_ACK === t.type) i(t, r);
      else {
        var n = o(t);
        r([n])
      }
      ...
      var r;
      if ("string" == typeof t) r = a(t), e.BINARY_EVENT === r.type || e.BINARY_ACK === r.type ? (this.reconstructor = new p(r), 0 === this.reconstructor.reconPack.attachments && this.emit("decoded", r)) : this.emit("decoded", r);
      else {
      ...
      e.deconstructPacket = function (t) {
        ...
        function r(t, a, u) {
          ...
          if (c && t instanceof Blob || p && t instanceof File) {
            ...
            h.onload = function () {
              u ? u[a] = this.result : o = this.result, --n || e(o)
    ...
    var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
      ...
      p = r(41),
      u = r(42),
      h = r(3)("socket.io-client:manager"),
      f = r(37),
      l = r(43),
    ...
    t.exports = n, n.prototype.emitAll = function () {
      ...
      if (!1 !== this._timeout) {
        ...
        var c = setTimeout(function () {
          h("connect attempt timed out after %d", a), o.destroy(), r.close(), r.emit("error", "timeout"), n.emitAll("connect_timeout", a)
        }, a);
        this.subs.push({
          destroy: function () {
            clearTimeout(c)
    ...
    (function (e) {
      ...
      t.exports = n, n.priorWebsocketSuccess = !1, s(n.prototype), n.protocol = p.protocol, n.Socket = n, n.Transport = r(22), n.transports = r(17), n.parser = r(23), n.prototype.createTransport = function (t) {
          ...
          h || (a('probe transport "%s" opened', t), u.send([{
            ...
            if (!h)
              if ("pong" === e.type && "probe" === e.data) {
                ...
                n.priorWebsocketSuccess = "websocket" === u.name, a('pausing current transport "%s"', f.transport.name), f.transport.pause(function () {
        ...
        function o(e) {
          ...
          n.transport = u.name, r(), a('probe transport "%s" failed because of error: %s', t, e), f.emit("upgradeError", n)
        }
        ...
        function c(t) {
          u && t.name !== u.name && (a('"%s" works - aborting "%s"', t.name, u.name), r())
        }
        ...
        var u = this.createTransport(t, {
          ...
          h = !1,
          f = this;
        n.priorWebsocketSuccess = !1, u.once("open", e), u.once("error", o), u.once("close", i), this.once("close", s), this.once("upgrading", c), u.open()
      }, n.prototype.onOpen = function () {
    ...
    (function (e) {
      ...
      var a = r(18),
        ...
        p = r(8),
        u = r(32),
        h = r(3)("engine.io-client:polling-xhr");
    ...
    (function (t) {
      ...
      e.encodePacket = function (e, r, i, a) {
        ...
        try {
          ...
          for (var c = new Uint8Array(r.data), p = new Array(c.length), u = 0; u < c.length; u++) p[u] = c[u];
        ...
        var s = h(t);
        return r && s ? k && !g ? e.encodePayloadAsBlob(t, n) : e.encodePayloadAsArrayBuffer(t, n) : t.length ? void c(t, i, function (t, e) {
          return n(e.join(""))
        }) : n("0:")
        ...
        for (var o = t, i = []; o.byteLength > 0;) {
          for (var s = new Uint8Array(o), a = 0 === s[0], c = "", p = 1; 255 !== s[p]; p++) {
            if (c.length > 310) return n(w, 0, 1);
            c += s[p]
          }
    ...
    (function (t, o) {
      ! function (i) {
        ...
        function u(t, e) {
          ...
          var r = "";
          return 0 == (4294965248 & t) ? r = w(t >> 6 & 31 | 192) : 0 == (4294901760 & t) ? (c(t, e) || (t = 65533), r = w(t >> 12 & 15 | 224), r += p(t, 6)) : 0 == (4292870144 & t) && (r = w(t >> 18 & 7 | 240), r += p(t, 12), r += p(t, 6)), r += w(63 & t | 128)
        }

        function h(t, e) {
          e = e || {};
          for (var r, n = !1 !== e.strict, o = s(t), i = o.length, a = -1, c = ""; ++a < i;) r = o[a], c += u(r, n);
          return c
        }
    ...
    ! function () {
      ...
      e.encode = function (e) {
        ...
        var u = new ArrayBuffer(a),
          h = new Uint8Array(u);
        for (e = 0; e < c; e += 4) n = r[t.charCodeAt(e)], o = r[t.charCodeAt(e + 1)], i = r[t.charCodeAt(e + 2)], s = r[t.charCodeAt(e + 3)], h[p++] = n << 2 | o >> 4, h[p++] = (15 & o) << 4 | i >> 2, h[p++] = (3 & i) << 6 | 63 & s;
        return u
      }
    }()
  }, function (t, e) {
    ...
    (function (e) {
      ...
      var o, i = r(22),
        ...
        c = r(32),
        p = r(33),
        u = r(3)("engine.io-client:websocket"),
        h = e.WebSocket || e.MozWebSocket;
      if ("undefined" == typeof window) try {
        o = r(36)
      } catch (f) {}
      var l = h;
      l || "undefined" != typeof window || (l = o), t.exports = n, c(n, i), n.prototype.name = "websocket", n.prototype.supportsBinary = !0, n.prototype.doOpen = function () {
        if (this.check()) {
          var t = this.uri(),
            e = this.protocols,
            r = {
        ...
        var t = this.query || {},
          ...
          r = "";
        this.port && ("wss" === e && 443 !== Number(this.port) || "ws" === e && 80 !== Number(this.port)) && (r = ":" + this.port), this.timestampRequests && (t[this.timestampParam] = p()), this.supportsBinary || (t.b64 = 1), t = a.encode(t), t.length && (t = "?" + t);
        var n = this.hostname.indexOf(":") !== -1;
        return e + "://" + (n ? "[" + this.hostname + "]" : this.hostname) + r + this.path + t
